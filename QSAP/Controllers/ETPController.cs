...
namespace QSAP.Controllers
{
    public class ETPController : Controller
    {
        ...
        public ActionResult SendEmail(string email)
        {
            ...
            System.IO.File.WriteAllBytes(Server.MapPath("~/Docs/ETP.pdf"), binary);


            Mailer.SendMail(email, Server.MapPath("~/Docs/ETP.pdf"));



            if (System.IO.File.Exists(Server.MapPath("~/Docs/ETP.pdf"))) System.IO.File.Delete(Server.MapPath("~/Docs/ETP.pdf"));
        ...
        public ActionResult DownloadPDF()
        {
            ...
            return new ViewAsPdf("PDF", pdfInfo) { FileName = "ETP.pdf" };
        }
