...
namespace QSAP.Controllers
{
    public class PartnershipsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //    qr = GetQuestionInfo(1, 1);
            //}
            //else{
            //    CurrentInfo cInfo = (CurrentInfo) Session["CurrentInfo"];
            //    qr = GetQuestionInfo(cInfo.currentCategoryId, cInfo.currentSectionNum);
        ...
        public ActionResult SendEmail(string email)
        {
            ...
            System.IO.File.WriteAllBytes(Server.MapPath("~/Docs/Partnerships.pdf"), binary);


            Mailer.SendMail(email, Server.MapPath("~/Docs/Partnerships.pdf"));



            if (System.IO.File.Exists(Server.MapPath("~/Docs/Partnerships.pdf"))) System.IO.File.Delete(Server.MapPath("~/Docs/Partnerships.pdf"));
        ...
        public ActionResult DownloadPDF()
        {
            ...
            return new ViewAsPdf("PDF", pdfInfo) { FileName = "Partnership.pdf" };
        }
