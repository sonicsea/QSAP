...
namespace QSAP.Controllers
{
    public class GovernanceController : Controller
    {
        ...
        public ActionResult SendEmail(string email)
        {
            ...
            System.IO.File.WriteAllBytes(Server.MapPath("~/Docs/StateLeadershipAndGovernance.pdf"), binary);


            Mailer.SendMail(email, Server.MapPath("~/Docs/StateLeadershipAndGovernance.pdf"));

            

            if (System.IO.File.Exists(Server.MapPath("~/Docs/StateLeadershipAndGovernance.pdf"))) System.IO.File.Delete(Server.MapPath("~/Docs/StateLeadershipAndGovernance.pdf"));
        ...
        public ActionResult DownloadPDF()
        {
            ...
            return new ViewAsPdf("PDF", pdfInfo) { FileName = "StateLeadershipAndGovernance.pdf" };
        }
