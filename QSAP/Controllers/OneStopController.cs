...
namespace QSAP.Controllers
{
    public class OneStopController : Controller
    {
        ...
        public ActionResult SendEmail(string email)
        {
            ...
            System.IO.File.WriteAllBytes(Server.MapPath("~/Docs/OneStopServiceDelibery.pdf"), binary);


            Mailer.SendMail(email, Server.MapPath("~/Docs/OneStopServiceDelibery.pdf"));



            if (System.IO.File.Exists(Server.MapPath("~/Docs/OneStopServiceDelibery.pdf"))) System.IO.File.Delete(Server.MapPath("~/Docs/OneStopServiceDelibery.pdf"));
        ...
        public ActionResult DownloadPDF()
        {
            ...
            return new ViewAsPdf("PDF", pdfInfo) { FileName = "OneStopServiceDelibery.pdf" };
        }
