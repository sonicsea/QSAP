...
{
    public class LocalLeaderController : Controller
    {
        //
        // GET: /LocalLeader/

        private const int QSAP_ID = 6;
        ...
        public ActionResult SendEmail(string email)
        {
            ...
            System.IO.File.WriteAllBytes(Server.MapPath("~/Docs/LocalLeadership.pdf"), binary);


            Mailer.SendMail(email, Server.MapPath("~/Docs/LocalLeadership.pdf"));



            if (System.IO.File.Exists(Server.MapPath("~/Docs/LocalLeadership.pdf"))) System.IO.File.Delete(Server.MapPath("~/Docs/LocalLeadership.pdf"));
        ...
        public ActionResult DownloadPDF()
        {
            ...
            return new ViewAsPdf("PDF", pdfInfo) { FileName = "LocalLeadership.pdf" };
        }
